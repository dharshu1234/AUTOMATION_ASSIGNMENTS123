...
import Pages.Random_updating;

public class Random_email_generation {
	// constructor
...
//		Assert.assertTrue(vootlogo.isDisplayed(), "Voot logo not displayed");
	...
	public static void navigateToMyAccounttab() throws Exception {
		...
		driver.findElement(Random_updating.objMyAccountTab).click();
		
		Thread.sleep(5000);
		Random randomGenerator = new Random();
		int randomInt = randomGenerator.nextInt(1000);
		driver.findElement(Random_updating.objEmail).sendKeys("username" + randomInt + "@gmail.com");

	//	driver.findElement(HomePages.objEmail).sendKeys("dharshanrm789526@gmail.com");
		driver.findElement(Random_updating.objPassword).sendKeys("dharshanrm32@gmail.com");
		
		driver.findElement(Random_updating.objRegister).click();
		Thread.sleep(5000);

		driver.findElement(Random_updating.objAddresses).click();
		driver.findElement(Random_updating.obJbillingEdit).click();
		Thread.sleep(5000);

		driver.findElement(Random_updating.ObjFirst_name).sendKeys("Kiran");
		driver.findElement(Random_updating.objLast_name).sendKeys("H M");
		Thread.sleep(5000);
		System.out.println("First and last name done");
		driver.findElement(Random_updating.objCompanyName).sendKeys("xyzghi");
	    driver.findElement(Random_updating.objPhone ).sendKeys("8660034975");
	    ...
	    driver.findElement(Random_updating.objAddress1).sendKeys("#34 Door no, 6th main 2nd phase");
		driver.findElement(Random_updating.objAddress2).sendKeys("5th cross 3rd floor");
		
		driver.findElement(Random_updating.objCity).sendKeys("Bangalore");
		Thread.sleep(5000);

		driver.findElement(Random_updating.objState).click();



		driver.findElement(Random_updating.objState1).sendKeys("Kerala");



		driver.findElement(Random_updating.objState2).click();
		
		driver.findElement(Random_updating.objPostcode).sendKeys("5600890");
		driver.findElement(Random_updating.objSaveAddress).click();
