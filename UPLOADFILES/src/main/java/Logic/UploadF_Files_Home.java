...
import Pages.Upload_FilesHome;

public class UploadF_Files_Home {
	// constructor
    ...
    public static void verifyVootLogo() throws InterruptedException{
       WebElement vootlogo = driver.findElement(Upload_FilesHome.objContactus);
    ...
    public static void navigateToContactus() throws InterruptedException {
    	Thread.sleep(5000);
    	driver.findElement(Upload_FilesHome.objContactus).click();
    	Select select = new Select(driver.findElement(Upload_FilesHome.objsubjectheading));select.selectByIndex(2);
	...
	//	int randomInt = randomGenerator.ne;xtInt(1000);
	   driver.findElement(Upload_FilesHome.objemailaddress).sendKeys(email);
	driver.findElement(Upload_FilesHome.objorderreference).sendKeys(firstName);
		Thread.sleep(5000);
		driver.findElement(Upload_FilesHome.objChooseFile).sendKeys("C:\\Users\\IGS0462\\Desktop\\igsdarshan.txt");
		Thread.sleep(5000);
		driver.findElement(Upload_FilesHome.objMessage).sendKeys("Hi this is Dharshan R M");
		Thread.sleep(5000);
		driver.findElement(Upload_FilesHome.objSend).click();
    
		
		
		String expected = "Your message has been successfully sent to our team.";
		WebElement actualMsg = driver.findElement(Upload_FilesHome.objSuccessMessage);
